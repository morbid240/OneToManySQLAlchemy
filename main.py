...
from Department_Query import add_department, select_department, delete_department, list_departments, list_department_courses
from Course_Query import add_course, select_course, delete_course
